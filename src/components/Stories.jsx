  ...
  return (
    <div className='w-full h-full flex flex-col deep-shadow relative'>
        ...
        <div className='w-full h-fit absolute bottom-2 text-white deep-shadow pl-2 pt-2'>
            <p className='text-justify max-w-[80%] font-medium truncate hover:underline cursor-pointer text-[0.95vw]'>{props.news}</p>
            <p className='text-[rgba(255,255,255,0.9)] text-[0.75vw]'>{props.date}</p>
        </div>
    </div>
  )
}

  ...
  return (
    <div className='w-full h-full flex flex-col deep-shadow relative'>
        ...
        <div className='w-full h-fit absolute bottom-2 text-white deep-shadow pl-2 pt-2'>
            <p className='text-justify max-w-[80%] font-black tracking-tight truncate hover:underline cursor-pointer'>{props.news}</p>
            <p className='font-light text-[rgba(255,255,255,0.9)] text-[12px]'>{props.date}</p>
        </div>
    </div>
  )
}
